...
async function tgEODSummary(){
  ...
  if(dailyOutcomeLog.length){
    ...
    dailyOutcomeLog.forEach(o=>{
      ...
      const out=o.outcome==='SL'?'\uD83D\uDEAB STOP LOSS':o.outcome==='TP1'?'\u2705 TP1 HIT':o.outcome==='TP2'?'\uD83D\uDCB0 FULL TARGET':'\u2705 WIN (TP1 Secured)';
