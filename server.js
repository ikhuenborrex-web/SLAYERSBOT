  ...
  saveTimer=setTimeout(()=>{
    try{
      const state={
        ...
        qmrSeen:[...qmrSeen],crtSeen:[...crtSeen],
        savedAt:Date.now()
      };
        ...
        try{
          ...
          for(const qmr of qmrs){
            ...
            if(!qmrSeen.has(key)){
              ...
              if(qmrTF==='4H'){
                refinedEntry=await refine4HEntry(inst,qmr.type,entry2,sl2);
              ...
              activeQMRTrades.push({instId:inst.id,instName:instObj.name,tf:qmrTF,type:qmr.type,qmLevel:entry2,sl:sl2,tp1:tp1_q,tp2:tp2_2,beLevel:isB2?entry2+slDist2:entry2-slDist2,origSL:sl2,isElite:qmr.criteria.score>=4,eliteFactors:qmr.criteria.factors,dailyPOI:qmr.dailyPOI||null,dec:instObj.dec,beFired:false,tp1Fired:false,tp2Fired:false,slFired:false,trailSuggested:false,openTime:Date.now()});
...
<p class="dim" style="margin-top:20px">The Slayers Model by Rex Roz | v8.1</p>
</body></html>`);
});
...
log('Slayers Alert System v8.1 starting...');
loadState();
