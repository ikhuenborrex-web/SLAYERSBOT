...
function render() {
  ...
  app.innerHTML = `
    ...
    ${members.length === 0 ? `<div style="color:${GREY};font-size:13px;text-align:center;padding:30px 0">No members yet.</div>` : members.map(m => `
      <div style="background:${PANEL};border:1px solid ${BORDER};border-radius:12px;padding:14px;margin-bottom:10px;display:flex;justify-content:space-between;align-items:center">
        <div>
