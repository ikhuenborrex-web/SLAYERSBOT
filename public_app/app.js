...
function detailPage(s) {
  ...
  return `
  <div style="display:flex;flex-direction:column;height:100dvh;background:${BLACK};color:${WHITE}">
...
function render() {
  ...
  app.innerHTML = `
    <div style="display:flex;flex-direction:column;height:100dvh;background:${BLACK};color:${WHITE}">
      <div style="flex:1;overflow-y:auto;padding:0 16px 10px;background:${BLACK};color:${WHITE}" id="content">
...
function renderLogin(errorMsg) {
  const app = document.getElementById('app');
  app.innerHTML = `
    <div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:calc(24px + env(safe-area-inset-top)) 24px calc(24px + env(safe-area-inset-bottom));text-align:center;background:${BLACK};color:${WHITE}">
