...
function detailPage(s){
  ...
  return '<div style="display:flex;flex-direction:column;height:100dvh;background:'+C.bg+';color:'+C.white+'">'+
    ...
    '<span style="color:'+C.lime+'">\u25cf Entry</span>'+
    '<span style="color:'+C.red+'">\u25cf SL</span>'+
    '<span style="color:'+C.lime+'">\u25cf TP</span></div>'+
    ...
    (s.refinedEntry?'<div style="display:flex;justify-content:space-between;padding:9px 0"><span style="color:'+C.lime+'">'+icon('target',C.lime,13)+' Refined Entry</span>'+mono(fmt(s.refinedEntry),C.lime,16)+'</div>':'')+
    '<div style="display:flex;justify-content:space-between;padding:9px 0"><span style="color:'+C.red+'">'+icon('shield',C.red,13)+' Stop Loss</span>'+mono(fmt(s.sl),C.red,16)+'</div>'+
    (s.tp1?'<div style="display:flex;justify-content:space-between;padding:9px 0"><span style="color:'+C.text2+'">TP1</span>'+mono(fmt(s.tp1),C.white,16)+'</div>':'')+
    (s.tp2?'<div style="display:flex;justify-content:space-between;padding:9px 0"><span style="color:'+C.text2+'">TP2</span>'+mono(fmt(s.tp2),C.lime,16)+'</div>':'')+
    '</div>'+
    ...
    '<button onclick="window.open(\'https://slayerbotcalculator.netlify.app/#'+s.pair.replace('/','')+','+s.entry+','+s.sl+'\',\'_blank\')" style="width:100%;background:'+C.lime+';border:none;border-radius:10px;padding:15px 0;display:flex;align-items:center;justify-content:center;gap:8px;cursor:pointer;margin-bottom:24px">'+
...
function statsOverview(){
  ...
  return '<div style="display:flex;gap:8px;margin-bottom:14px">'+
    ...
    '<div class="count-up" style="font-size:24px;font-weight:800;color:'+C.lime+';margin-top:2px;letter-spacing:-0.5px" data-target="'+(st.winRate||0)+'">0</div></div>'+
    ...
    '<div class="count-up" style="font-size:24px;font-weight:800;color:'+C.lime+';margin-top:2px;letter-spacing:-0.5px" data-target="'+(st.totalR||0)+'" data-dur="800">0</div></div>'+
...
function journalScreen(){
  ...
  function entryHtml(e){
    ...
    var notesHtml=e.notes?'<div style="font-size:11.5px;color:'+C.text2+';margin-top:5px;line-height:1.4">'+e.notes+'</div>':'';
  ...
  return '<div style="display:flex;align-items:center;justify-content:space-between;padding-top:12px;margin-bottom:14px">'+
    ...
    '<div style="text-align:center"><div class="count-up" style="font-size:22px;font-weight:800;color:'+C.lime+';letter-spacing:-0.5px" data-target="'+wr+'">0</div><div style="font-size:9px;color:'+C.text2+';font-weight:500;margin-top:2px">Win Rate</div></div>'+
    '<div style="text-align:center"><div class="count-up" style="font-size:22px;font-weight:800;color:'+C.lime+';letter-spacing:-0.5px" data-target="'+(totalR||0)+'" data-dur="800">0</div><div style="font-size:9px;color:'+C.text2+';font-weight:500;margin-top:2px">Total R</div></div>'+
...
function newsScreen(){
  ...
  if(heroArticle){
    ...
    heroHtml='<div class="card" style="padding:0;overflow:hidden;border-color:'+heroCatColor+'1E;animation-delay:0s">'+
      '<div style="height:140px;background:linear-gradient(135deg,rgba(0,0,0,0.6),rgba(255,255,255,0.04));display:flex;align-items:flex-end;position:relative">'+
  ...
  if(filtered.length>1){
    for(var i=1;i<filtered.length;i++){
      ...
      articlesHtml+='<div class="card" style="padding:12px 16px;cursor:pointer;animation-delay:'+(i*0.03)+'s">'+
        ...
        (a.summary?'<div style="font-size:11px;color:'+C.text2+';margin-top:4px;line-height:1.4">'+a.summary+'</div>':'')+
        '</div></div></div>';
    }
  }
...
function overviewScreen(){
  ...
  var headerHtml='<div style="display:flex;align-items:center;justify-content:space-between;padding-top:0;margin-bottom:18px">'+
    '<div><div style="font-size:14px;font-weight:500;color:'+C.text2+'">'+greeting()+'</div>'+
