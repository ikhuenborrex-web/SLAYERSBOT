...
function priceBar(s) {
  ...
  return '<div style="position:relative;height:18px;margin:8px 0 0">' +
    '<div style="position:absolute;top:7px;left:0;right:0;height:4px;background:' + barBg + ';border-radius:99px">' +
    ...
    '</div>' +
    '<div style="position:absolute;top:1px;left:' + sPct + '%;width:10px;height:10px;border-radius:50%;background:' + RED + ';border:1.5px solid ' + BLACK + ';transform:translateX(-50%);z-index:2" title="SL"></div>' +
    '<div style="position:absolute;top:1px;left:' + ePct + '%;width:10px;height:10px;border-radius:50%;background:' + MINT + ';border:1.5px solid ' + BLACK + ';transform:translateX(-50%);z-index:3" title="Entry"></div>' +
    '<div style="position:absolute;top:1px;left:' + tPct + '%;width:10px;height:10px;border-radius:50%;background:' + GOLD + ';border:1.5px solid ' + BLACK + ';transform:translateX(-50%);z-index:2" title="TP1"></div>' +
    '<div style="display:flex;justify-content:space-between;font-size:7.5px;color:' + GREY + ';margin-top:14px;font-weight:600;padding:0 2px">' +
    '<span style="color:' + RED + '">' + fmt(sl) + '</span>' +
    '<span style="color:' + MINT + '">' + fmt(entry) + '</span>' +
    '<span style="color:' + GOLD + '">' + fmt(tp1) + '</span></div></div>';
}
